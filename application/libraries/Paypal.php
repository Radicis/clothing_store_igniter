...
class Paypal {
    ...
    {
        #Account information
        $config["business"] 	= 'janelee920@gmail.com'; //Account email or id
        ...
        $config["first_name"] 		= 'Jane';
        $config["last_name"] 		= 'Lee';
        $config["address1"] 		= 'CIT';
        $config["address2"] 		= 'Bishopstown';
        $config["city"] 			= 'Cork';
        $config["state"] 			= '';
        $config["zip"] 				= '';
        $config["email"] 			= 'janelee920@gmail.com';
        $config["night_phone_a"] 	= '0863328210';
     ...
     * @return	void
     */
    function add($item_name = '',$item_amount = NULL,$item_qty = NULL,$item_shipping = NULL){
        ...
        $this->config['shipping_' . $this->item]    = $item_shipping;
        $this->item++;
    }
}
